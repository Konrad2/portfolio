<?php
class dataFromClient  extends  abstract_formDbClient //forms_factoryClient
{
	...
	public function insert($params){
		...
		echo "jeewjewjewfajfgj";
		$s = new sale();		
		
		$row = $s->makeOrder($this->values(),$params);
		
		$this->child->doInsert($row, $this->values());
	}
}
?>