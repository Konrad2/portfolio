...
abstract class Zend_Controller_Request_Abstract
{
	...
	/**
	 * Moja funkcja. Zwraca parametr przeflitrowany według wzorca int.
	 * 
	 * @return integer
	 */
	public function getIntParam($key, $default = null)
    {
		...
		return $f->filter($this->getParam($key));       
    }
    

    public function getAlNumParam($key){
