...
class Abstract_library_AdapterTable extends  Zend_Auth_Adapter_DbTable {//extends Zend_Db_Table_Abstract {
...
*/
	...
	public function loog( $login, $password ) {
	  ...
	  //  															$this->__nameLoginColumn,  $this->__namePasswordColumn );
		...
		$salt = $passwordManager->getSalt($login);
		
		$password = $passwordManager->salts( $password , $salt);
